...
<head>
    <meta charset="utf-8">
    <title>
        Laracinema - Admin pour les films
    </title>
    ...
    <!-- FullCalendar Plugin CSS: asset Permet de generer un lien a partir de public -->
...
<div id="main">
    ...
    <header class="navbar navbar-fixed-top navbar-shadow">
        ...
        <form method="get" action="{{ route('search') }}" class="navbar-form navbar-left navbar-search alt" role="search">
            <div class="form-group">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown menu-merge">
                <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
                    <img src="/assets/img/stock/3.jpg" alt="avatar" class="mw30 br64">
                    <span class="hidden-xs pl15"> Mounir.T </span>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="media-links">
                                <a href="#" class="sidebar-menu-toggle">User Menu -</a> <a href="pages_login(alt).html">Deconnexion</a>
                            </div>
                            <div class="media-author">Mounir Taarabti</div>
                        </div>
                    </div>
                </div>
            ...
            <ul class="nav sidebar-menu">
                ...
                <li class="active">
                    <a href="">
                        ...
                        <span class="sidebar-title">Cinemas</span>
                    </a>
                </li>
